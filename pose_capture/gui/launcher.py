...
class PoseCaptureLauncherApp:
    ...
    def _build_ui(self) -> None:
        ...
        debug_check = tk.Checkbutton(frame, text="デバッグログを有効化", variable=self.debug_var)
        add_row("デバッグログ", debug_check)
    ...
    def _sync_from_args(self) -> None:
        ...
        self.debug_var.set(self.args.debug)
